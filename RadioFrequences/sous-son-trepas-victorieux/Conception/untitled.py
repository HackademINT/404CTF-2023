...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/run/media/rmoreau/ARCH_202303/404/404/de-la-radio-a-l-image/Conception/SSTV.wav', False)
        self.blocks_sigmf_sink_minimal_0 = blocks.sigmf_sink_minimal(
            ...
            hw_info='',
            is_complex=True)
        self.blocks_freqshift_cc_0 = blocks.rotator_cc(2.0*math.pi*40000/100000)
        ...
        self.connect((self.blocks_freqshift_cc_0, 0), (self.blocks_sigmf_sink_minimal_0, 0))
